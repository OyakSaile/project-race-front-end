...
export const Speedometer = ({ mph, quilometragem, rpm }: SpeedometerProps) => {
  ...
  return (
    <div className="font-monomaniac italic text-3xl items-end flex-col text-gray-300/40 leading-none font-bold drop-shadow-2xl flex">
      <div className="flex items-end gap-1">
        ...
        <p className="font-monomaniac font-medium not-italic">
          {quilometragem}
        </p>
      </div>
